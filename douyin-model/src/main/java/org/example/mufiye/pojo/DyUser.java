package org.example.mufiye.pojo;
...
public class DyUser {
     ...
     */
    @Column(name = "can_douyin_id_be_updated")
     ...
     *
     * @return douyin_id - 抖音号，唯一标识，需要限制修改次数，比如终生1次，每年1次，每半年1次等，可以用于付费修改。
     */
     ...
     *
     * @param douyinId 抖音号，唯一标识，需要限制修改次数，比如终生1次，每年1次，每半年1次等，可以用于付费修改。
     */
     ...
     *
     * @return can_douyin_id_be_updated - 抖音号能否被修改，1：默认，可以修改；0，无法修改
     */
    public Integer getCanDouyinIdBeUpdated() {
        return canDouyinIdBeUpdated;
    }

    /**
     * 设置抖音号能否被修改，1：默认，可以修改；0，无法修改
     *
     * @param canDouyinIdBeUpdated 抖音号能否被修改，1：默认，可以修改；0，无法修改
     */
    public void setCanDouyinIdBeUpdated(Integer canDouyinIdBeUpdated) {
        this.canDouyinIdBeUpdated = canDouyinIdBeUpdated;
    }
